...
<head>
    ...
    <meta name="description" content="MTs Negeri 01 Kayong Utara adalah aplikasi manajemen sekolah berbasis website yang di bangun dan di kembangkan dengan Framework Laravel">
    <meta name="keywords" content="">
    <meta name="author" content="MTs Negeri 01 Kayong Utara">
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="/">
                            ...
                            {{-- <h2 class="brand-text text-primary ml-5 pl-2">MTs Negeri 01 Kayong Utara</h2> --}}
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="{{asset('Assets/backend/images/illustration/sekolah.jpeg')}}" alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                @endif
                                <h2 class="card-title font-weight-bold mb-1">Selamat datang di MTs Negeri 01 Kayong Utara</h2>
