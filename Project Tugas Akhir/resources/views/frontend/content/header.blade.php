            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="header-top-left">
                        <div class="logo-area">
                            @if (@$footer->logo == NULL)
                            <img class="img-responsive" src="{{asset('Assets/Frontend/img/logo.jpeg')}}" alt="logo" width="60px">
                        @else
                ...
                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                    <div class="header-top-right">
                        <ul>
                            <li>
                                @auth
                                    <a href="/home" class="apply-now-btn2">Login Admin</a>
                                @else
                ...
                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                    <nav id="desktop-nav">
                        <ul>
                            ...
                            <li><a href="#">Profil</a>
                                <ul>
                                    <li><a href=" {{route('profile.sekolah')}} ">Sejarah</a></li>
                            ...
                            <li><a href="http://localhost:8080/ppdb/" target="_blank">PPDB</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
