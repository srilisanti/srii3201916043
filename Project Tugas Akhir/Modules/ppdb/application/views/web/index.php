        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">
                    ...
                    <span style="margin-left:45px;">&nbsp;PPDB MTsN</span>
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a href="http://127.0.0.1:8000/"><i class="fa fa-home"></i> HOME</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        <span class="name shad" style="font-size:35px; line-height: 35px;">
                            SELAMAT DATANG DI PPDB ONLINE <br> MTSN 01 KAYONG UTARA
                        </span>
                        <br>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12" style="margin-top:-10px;">
                    ...
                    <div class="col-md-8">
                        <h4 align="center">PPDB Online &copy; MTSN 01 KAYONG UTARA<br> JL. MERDEKA, KEC. SIMPANG HILIR, KAB KAYONG UTARA</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="text-center">
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        PPDB Online &copy; MTSN 01 KAYONG UTARA - <?php echo date('Y'); ?>
                    </div>
                </div>
            </div>
        </div>
