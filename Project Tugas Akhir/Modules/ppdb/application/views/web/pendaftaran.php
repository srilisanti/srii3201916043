            ...
            <div style="margin-top:-8px;">
              <h2>
                <strong class="text-primary">
                  <a href=""><span style="margin-left:40px;color:#fff;">PPDB MTSN</span></a>
                </strong>
              </h2>
            </div>
          </div>
      ...
      <div>
        ...
        <div class="page-content page-wizard">
          <div class="header" style="margin-top:-20px; text-align: center;">
            ...
            <h2 align="center">FORM PENDAFTARAN PPDB ONLINE <strong> <br>MTSN 01 KAYONG UTARA</strong></h2>
            ...
            <div class="footer">
              <div class="copyright">
                <p class="pull-left sm-pull-reset">
                  <span>Copyright &copy; PPDB MTSN 01 KAYONG UTARA <?php echo date('Y'); ?></span>
                </p>
                <p class="pull-right sm-pull-reset">
                  <span><a href="" class="m-r-10"><i class="fa fa-home"></i> Beranda </a></span>
                </p>
              </div>
            </div>
          </div>
