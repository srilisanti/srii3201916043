<div class="panel">
  ...
  <div class="panel-body">
    ...
    <div class="form-group" style="padding-bottom:30px;">
      <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Nilai SKHU <span class="text-danger">*</span></label>
      <div class="col-sm-9 prepend-icon">
        <input type="text" name="jml_saudara" class="form-control bg-blue" placeholder="Nilai SKHU" maxlength="100" data-parsley-group="block1" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-jml_saudara"]' required>
        <i class="fa fa-user" style="margin-left:15px;"></i>
