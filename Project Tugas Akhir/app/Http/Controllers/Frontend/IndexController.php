...
class IndexController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.welcome', compact('jurusanM','kegiatanM','slider','about','berita','event','footer'));
    }
    ...
    public function profileSekolah()
    {
        ...
        return view('frontend.content.profileSekolah', compact('profile','jurusanM','kegiatanM','footer'));
    }
    ...
    public function visimisi()
    {
        ...
        return view('frontend.content.visimisi', compact('visimisi','jurusanM','kegiatanM','footer'));
    }
